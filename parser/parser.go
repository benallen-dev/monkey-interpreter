...
// WARING: SIDE EFFECTS! This function calls p.nextToken() if peekToken is the correct type
...
// This function is only ever used once. In the function below it.
// TODO: Once I've completed the book I'm refactoring out all this
// "clean" code.
...
func (p *Parser) parseGroupedExpression() ast.Expression {
	...
	if !p.expectPeek(token.RPAREN) {
		// Error case, but expectPeek handles it
		return nil
	}
...
func (p *Parser) parseFunctionLiteral() ast.Expression {
	...
	// Advances curToken if it's LPAREN, adds error otherwise.
	if !p.expectPeek(token.LPAREN) {
		return nil
	}

	// Why, Thorsten, why must this be a seperate method? It's never used anywhere else.
...
func (p *Parser) parseCallExpression(function ast.Expression) ast.Expression {
	...
	exp.Arguments = p.parseCallArguments() // Again, what's the point of factoring this into a function
	return exp
}
